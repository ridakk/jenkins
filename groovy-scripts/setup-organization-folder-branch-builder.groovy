...
def org = jenkins.createProject(OrganizationFolder, 'Organization-Folder-Branch-Builder')
org.setDisplayName('Organization Folder Branch Builder')
...
navigator.traits = [
  ...
  new jenkins.scm.impl.trait.RegexSCMHeadFilterTrait('^(master|dev|development)'),
  new NotificationContextTrait('continuous-integration/jenkins/branch_build', true),
...
factory.scriptPath = 'pipelines/Organization-Folder-Branch-Builder/Jenkinsfile'
